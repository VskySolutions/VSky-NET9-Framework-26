<template>
  <q-input
    ...
    :error="error" :error-message="errorMessage" :readonly="readonly" :input-class="inputClass" :suffix="suffix" :autofocus="autofocus" class="text-number"
  >
...
const options = _.merge({ currency: "USD", currencyDisplay: "hidden", useGrouping: true }, props.options);
